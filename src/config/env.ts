...
const envSchema = z.object({
  ...
  ACCESS_COOKIE_NAME: z.string().default('pixelbros_access_token'),
  ACCESS_COOKIE_SECURE: z.enum(['true', 'false']).default('false').transform((v) => v === 'true'),
  ACCESS_COOKIE_SAMESITE: z.enum(['lax', 'strict', 'none']).default('lax'),
